...
from X.helper.data import Data
from X.helper.inline import inline_wrapper, paginate_help
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://graph.org/file/6f813e2d1d64528dc999d.jpg",
...
async def help_function(answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://graph.org/file/22d5927b2e9117c5b5e1e.jpg",
            input_message_content=InputTextMessageContent(
