...
from X.plugins.help import add_command_help

gif_categories = ['wink', 'pat', 'hug', 'face-palm']


@X.on_message(filters.command(["animu-gif", "anime-gif"], ".") & filters.me)
async def animu_gifs(bot: X, message: Message):
    cmd = message.command
...
@X.on_message(filters.command(["animu-quote", "anime-quote"], ".") & filters.me)
async def animu_fact(bot: X, message: Message):
    try:
