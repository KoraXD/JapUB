...
@X.on_message(filters.command(animals_without_facts, ["."]) & filters.me)
async def animal_image(bot: X, message: Message):
    cmd = message.command
...
@X.on_message(filters.command("fact", ".") & filters.me)
async def fact(bot: X, message: Message):
    cmd = message.command
