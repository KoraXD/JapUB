...
from X import X
from X.helpers.file_sending_helpers import send_saved_animation, send_saved_image
...
@X.on_message(filters.command(memes, ".") & filters.me)
async def fixed_memes(bot: X, message: Message):
