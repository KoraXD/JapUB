...
from JapaneseX import CMD_LIST
from JapaneseX import ALIVE_NAME
from JapaneseX import PHOTO
from JapaneseX.utils import admin_cmd, sudo_cmd
...
async def cmd_list(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/" , "#", "-", "_", "@"):
        ...
        if tgbotusername is None or input_str == "text":
            ...
            if len(string) > 69:
                ...
                with io.BytesIO(str.encode(string)) as out_file:
                    ...
                    await bot.send_file(
                        ...
                        caption="¢σммαη∂ѕ ιη נαραηεsε υsεявσт",
            ...
            help_string = f""" נαραηεsε χ вσт Hᴇʟᴘ ᴘʀᴏᴠɪᴅᴇᴅ ʙʏ тєαм נαραηεsε χ\n
...
@borg.on(admin_cmd(pattern="nobitaaxd"))  # pylint:disable=E0602
...
async def _(event):
    ...
    await event.edit("тєℓєтнση  вαѕє∂ υѕєявσт ρσωєяє∂ ву נαραηεsε x υsεявσт")
